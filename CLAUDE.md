# cmdit — Claude Code Instructions
...
_TODO: one-or-two-sentence mission statement. What does cmdit OWN in the stack? Durable — doesn't change per release._
...
cyrius build programs/smoke.cyr build/cmdit-smoke
